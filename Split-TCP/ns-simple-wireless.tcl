...
set f0 [open vegas.tr w]
set f1 [open vegas-cong.tr w]
$ns namtrace-all $nf
...
proc finish {} {
	...
	close $f1
        ...
        exec nam out.nam &
	#exec xgraph -x "Time in seconds" -y "CONGWND" -t "CONGESTION" vegas-cong.tr &
	exec xgraph vegas.tr -geometry 800x800 &
...
$ns at 19.5 "$ns detach-agent $n0 $tcp ; $ns detach-agent $n3 $sink"
