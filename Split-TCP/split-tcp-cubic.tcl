...
set f0 [open cubic.tr w]
set f1 [open cubic-cong.tr w]
$ns namtrace-all $nf
...
proc finish {} {
	...
	close $f1
        ...
        exec nam out.nam &
	exec xgraph -x "Time in seconds" -y "CONGWND" -t "CONGESTION" cubic-cong.tr -geometry 1000x1000 &
	#exec xgraph cubic.tr -geometry 800x800 &
